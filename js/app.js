(function() {
    ...
    function addVendorPrefixes() {
        $$('[data-tooltip-property]').forEach(function(tip, i) {
            ...
            var str = ['/* Necesita vendor prefixes. */'];
            ...
            if ('tooltipJs' in tip.dataset) {
                ...
                support.forEach(function(prefix, i) {
                    ...
                    if (property[0] == property[0].toUpperCase() && !('tooltipLowercase' in tip.dataset)) {
    ...
    // I don't know how appropriate is to say this, but I felt very attracted to you. You're so beautiful, but more than that, smart. 

    (function() {
        var recognition = new webkitSpeechRecognition();
        var input = document.querySelector('#speech-recog-example input');
        var button = document.querySelector('#speech-recog-example button');
        var listening = false;
